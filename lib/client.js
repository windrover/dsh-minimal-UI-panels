...
//#region lib/types/client/locales.js
		...
		const css = [
			...
			".dap-controls{display:flex;flex-wrap:wrap;gap:6px 8px;align-items:center;min-width:0}",
...
//#region lib/types/client/locales.js
		...
		function MemoryPanel(props) {
			...
			const filterRow = react.createElement("div", { style: { display: "flex", flexWrap: "nowrap", gap: 6, marginBottom: 8, minWidth: 0 } },
				...
				react.createElement("select", { value: scopeFilter, onChange: (e) => setScopeFilter(e.target.value), style: { flex: "0 1 110px", width: 110, minWidth: 0, maxWidth: 110 } },
					react.createElement("option", { value: "all" }, t("panel.filter")),
					...scopeOptions,
				),
				react.createElement("select", { value: catFilter, onChange: (e) => setCatFilter(e.target.value), title: t("panel.categoryAll"), style: { flex: "0 1 130px", width: 130, minWidth: 0, maxWidth: 130 } },
