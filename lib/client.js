		...
		function NotesPanel() {
			...
			return react.createElement("div", { style: panelStyle },
				react.createElement("div", { style: toolbarStyle },
					react.createElement("button", { style: { ...buttonStyle, alignSelf: "auto", padding: "2px 7px", background: "rgba(60,140,255,.2)", borderColor: "rgba(60,140,255,.4)", fontWeight: 500 }, onClick: createNote }, t("notes.new")),
					react.createElement("button", { style: { ...buttonStyle, alignSelf: "auto", padding: "2px 7px" }, onClick: deleteNote, disabled: !activeId }, t("notes.delete")),
