...
//#region lib/types/client/locales.js
		...
		function ArtifactsPanel({ sessionId, useSessions, useWorkspaces, closeDetails, t, embedded }) {
			...
			// when it points inside the sessions tree — otherwise the default
			// per-session list takes over and the user can still drill down
			// into any session folder.
			const safeDir = (dir !== null && dir !== "" && sessionsRoot !== null && (dir === sessionsRoot || dir.startsWith(sessionsRoot + "/"))) ? dir : null;
