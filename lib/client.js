...
//#region lib/types/client/locales.js
		...
		function ArtifactsPanel({ sessionId, useSessions, useWorkspaces, closeDetails, t, embedded }) {
			...
			// when it points inside the sessions tree or the workspace root —
			// the user can still drill into any session folder or step back
			// up to the workspace via the "workspace: DSH" entry.
