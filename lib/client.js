...
//#region lib/types/client/locales.js
		...
		const css = [
			...
			".dap-controls{display:flex;flex-wrap:nowrap;gap:6px 8px;align-items:center;overflow-x:auto;min-width:0}",
...
//#region lib/types/client/locales.js
		...
		function MemoryPanel(props) {
			...
			const filterRow = react.createElement("div", { style: { display: "flex", flexWrap: "nowrap", gap: 6, marginBottom: 8, minWidth: 0 } },
				...
				react.createElement("select", { value: scopeFilter, onChange: (e) => setScopeFilter(e.target.value), style: { flex: "0 0 110px", width: 110, minWidth: 0 } },
					react.createElement("option", { value: "all" }, t("panel.filter")),
					...scopeOptions,
				),
				react.createElement("select", { value: catFilter, onChange: (e) => setCatFilter(e.target.value), title: t("panel.categoryAll"), style: { flex: "0 0 130px", width: 130, minWidth: 0 } },
			...
			return react.createElement("div", { style: { padding: 10, fontSize: 13, overflow: "auto", height: "100%" } },
...
const NS = "terminal-notes";
		...
		function TerminalPanel() {
			...
			return react.createElement("div", { style: termWrap },
				...
				output === "" && !error && react.createElement("div", { style: hintStyle },
					...
					hints.map((h, i) => react.createElement("div", { key: i, style: { display: "flex", gap: 8, justifyContent: "space-between" } },
						react.createElement("span", { style: { color: "#aab4c2" } }, h[0]),
						react.createElement("span", { style: { color: "#8a94a3" } }, t(h[1])),
					)),
				),
			);
		}
		...
		function NotesPanel() {
			...
			const toolbarStyle = {
				...
				minWidth: 0, overflowX: "auto", flex: "0 0 auto",
			};
			const rowStyle = {
				display: "flex", gap: 8, flex: "1 1 0%", minWidth: 0, minHeight: 0, overflow: "auto",
			};
